...
class ArticleController extends Controller
{
    ...
    {$data = (new Category)->tree();
        return view('user.article.create',compact('data'));
    ...
    {$data = (new Category)->tree();
       // return view('admin.article.create',compact('data'));
        return view('user/article/edit',compact('data'))->withArticle(Article::find($id));
    }
